...
- **GNOME Shell Extension**: Adds a premium Quick Settings toggle (pill button) with a status submenu and a native settings preferences page.
...
4. **Enable the Extension**:
   ...
   ```
   *Alternatively, search for and enable "WiFi Down Restart" in the **Extensions** or **Extension Manager** application.*
